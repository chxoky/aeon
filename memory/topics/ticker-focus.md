...
- **BTC**: KillaXBT (2X swing long, HTF-bullish, "bear cycle ending"; small LTF scalp short hedge filled 67.2K) + HeartCanHodl (majors spot long, but trimming/covering >50% into 66–67k; **2026-06-25 real-time observation: "Ugly breakdown of 60k"** = BTC broke below 60k support level, validates HCH's cautious/de-risked posture) + Crypto_Chase (FLAT, resting bids below, watching). **RECENT UPDATE (2026-06-25T13:56Z)**: BTC experienced "ugly breakdown" of 60k psychological level (bearish technical signal). Group lean: **MIXED → cautiously bearish near-term** — BTC rallied into 66–67k on Iran-deal + FOMC, but now breaking below prior 60k support. Killa still HTF bullish but may face test on LTF scalp hedge; HCH de-risked in advance, now validated by breakdown; Chase waiting confirmed.
