...
*Seeded by trader-bootstrap, 3-day lookback (2026-06-03 → 2026-06-06). X cache was empty this window — Discord-only state. Shorthand: `pf` = % of portfolio, `1x/2x/10x` = leverage, `R` = risk unit, `fc/sc` = chart link, `BE` = breakeven, `SL/TP` = stop/take-profit.*
...
- Watching (not entered): INTC low-90s→mid-80s, MU (Micron) ~820→790, S&P/ES bid level on a strong pullback. Would risk ~3R if INTC→mid-70s / MU→low-600s.
...
- Current open positions (as of bootstrap): **BTC low-leverage swing LONG, 75% exposed** (built 06-04 after closing an earlier scalp/long that got no bounce). Explicitly a long-hold position.
...
- Current open positions (as of bootstrap): **Hedged book.** Spot longs BTC/ETH/SOL (added ~5% each 06-04, entered underside 62.9K) hedged 2x short on all three at 63-64K. Standalone shorts: LAB (half still on after TP'ing half at $11; thesis -90% "luna of cycle", entered $16-20 1x), ZEC (2x, another "luna candidate"), WLD (2x, SL at BE), HYPE (short hedge), VVV (added 2% pf 3x on 06-06 — most recent action).
- Recent thesis/posture: Bearish/defensive — expects more downside, possible cascade toward ETH 1200s/1300s. Sub-63K = high risk; above 63K = safe to hold. Likes ETH lows as MTF/HTF buy zone. Prefers holding green shorts/hedges through Asia overnight, re-evaluates next day.
